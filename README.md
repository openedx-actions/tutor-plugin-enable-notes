...
[![Tests](https://github.com/openedx-actions/tutor-plugin-enable-notes/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-plugin-enable-notes/actions)
...
Github Action to install and enable the Tutor plugin - Open edX Notes service
  ...
  build:
    ...
    steps:
      ...
      - name: Enable tutor plugin - Notes
        uses: openedx-actions/tutor-enable-plugin-notes
        with:
          namespace: openedx-prod
